  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      void main() {
        ...
        // Colors slightly tweaked to fit Cloud Nova Blue & Purple vibes
        color = vec3(0.1, 0.2, 0.8); // Base deep blue
        color = mix(color, vec3(0.4, 0.1, 0.9), 0.32 + 0.16 * sin(2.0 * u_scroll_progress + 1.2));
        color += vec3(0.05, 0.4, 0.9) * sin(2.0 * u_scroll_progress + 1.5);
        color = color * noise;
    ...
    containerEl.addEventListener('pointermove', handleMouseMove);
